import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as i,c as p,d as o,a as s,b as l,e as c,f as n}from"./app-Gq6XPTBq.js";const r="/pinkpig/assets/package_and_module-eeamwuF2.png",u="/pinkpig/assets/package_and_directory-wDV22_zQ.png",d="/pinkpig/assets/regular_expression-AC09umgh.png",k={},m=n('<h1 id="python的包与模块" tabindex="-1"><a class="header-anchor" href="#python的包与模块" aria-hidden="true">#</a> Python的包与模块</h1><ul><li><ol><li>包、模块与__init__.py</li></ol></li><li><ol start="2"><li>Python文件内部</li></ol></li><li><ol start="3"><li>python内置模块</li></ol></li><li><ol start="4"><li>应用</li></ol></li></ul>',2),v=n('<h2 id="_1-包、模块与-init-py" tabindex="-1"><a class="header-anchor" href="#_1-包、模块与-init-py" aria-hidden="true">#</a> 1. 包、模块与__init__.py</h2><h3 id="_1-1-包-package" tabindex="-1"><a class="header-anchor" href="#_1-1-包-package" aria-hidden="true">#</a> 1.1. 包 Package</h3><p>包是指含有__init__.py的文件夹，如果没有__init__.py则不是包</p><p>包里包含的内容：<strong>init</strong>.py，模块，子包</p><figure><img src="'+r+'" alt="包与模块" tabindex="0" loading="lazy"><figcaption>包与模块</figcaption></figure><figure><img src="'+u+`" alt="包与目录" tabindex="0" loading="lazy"><figcaption>包与目录</figcaption></figure><h3 id="_1-2-模块-modules" tabindex="-1"><a class="header-anchor" href="#_1-2-模块-modules" aria-hidden="true">#</a> 1.2. 模块 Modules</h3><p>模块是指包里的python文件</p><p>模块是一个文件，里面包含变量，函数等</p><p>A module can contain multiple objects, such as classes, functions, etc.</p><p>包是一个文件夹，包含有一个或多个模块</p><p>A package can contain one or more relevant modules.</p><p>A package is actually a folder containing one or more module files.</p><h3 id="_1-3-init-py" tabindex="-1"><a class="header-anchor" href="#_1-3-init-py" aria-hidden="true">#</a> 1.3. __init__.py</h3><p>三个主要作用：</p><p>1）标识其所在目录为一个python包，可以被其他代码导入使用</p><p>2）初始化python包，可以被理解为是包的构造函数，当一个包被第一次引入时会被执行，可以将一些初始化代码放如此</p><p>3）控制导入行为：在__init__.py中定义可以被外界调用的类和方法。</p><p>导入所有（from xxx import *）：可以通过设置 <code>__all__</code> 变量来指定包被import * 导入时，应该导入哪些模块</p><p>导入指定（from xxx import yyy）: 如果有__getattr__方法，导入前会调用该方法</p><p>注意：</p><ul><li><code>__init__.py</code>文件可以为空</li><li>不能把其它同级目录的文件导入此package中</li><li>如果有多个类和方法名字相同，那么后导入的会覆盖先导入的</li></ul><h2 id="_2-python文件内部" tabindex="-1"><a class="header-anchor" href="#_2-python文件内部" aria-hidden="true">#</a> 2. Python文件内部</h2><h3 id="_2-1-导入" tabindex="-1"><a class="header-anchor" href="#_2-1-导入" aria-hidden="true">#</a> 2.1. 导入</h3><p>1、导入整个模块</p><ul><li>import module_name</li><li>from module_name import * # 使用更便捷</li></ul><p><em>Note：用</em> from statistics import * 代替 import statistics，可以避免前面都加statistics.mean(xxx)，</p><p>从而可以直接使用导入的函数mean(xxx)</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># main.py file</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-内置变量-name" tabindex="-1"><a class="header-anchor" href="#_2-4-内置变量-name" aria-hidden="true">#</a> 2.4. 内置变量__name__</h3><ul><li>在本文件中，__name__的值为‘__main__’</li><li>在该文件作为模块被导入到其他文件中，被导入模块的__name__值为导入的模块名</li></ul><h2 id="_3-python内置模块" tabindex="-1"><a class="header-anchor" href="#_3-python内置模块" aria-hidden="true">#</a> 3. python内置模块</h2><h3 id="_3-1-os" tabindex="-1"><a class="header-anchor" href="#_3-1-os" aria-hidden="true">#</a> 3.1. os</h3><p>os：(operating system)操作系统</p><p>用途：操作文件夹或文件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># import the module
import os
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-应用" tabindex="-1"><a class="header-anchor" href="#_4-应用" aria-hidden="true">#</a> 4. 应用</h2><h3 id="_4-1-抓取网站数据" tabindex="-1"><a class="header-anchor" href="#_4-1-抓取网站数据" aria-hidden="true">#</a> 4.1. 抓取网站数据</h3><ul><li>使用requests从url获取数据</li><li>使用BeautifulSoup解析页面内容</li></ul>`,114),b={href:"https://www.crummy.com/software/BeautifulSoup/bs4/doc/#quick-start",target:"_blank",rel:"noopener noreferrer"},h=n(`<p>导包</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>pip install requests
