import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,f as d}from"./app-xqJ9qOxH.js";const a={},s=d(`<h1 id="python算法刷题语法快速恢复" tabindex="-1"><a class="header-anchor" href="#python算法刷题语法快速恢复" aria-hidden="true">#</a> Python算法刷题语法快速恢复</h1><h2 id="关键词" tabindex="-1"><a class="header-anchor" href="#关键词" aria-hidden="true">#</a> 关键词</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>and 与  
or  或  
not 非  
in  包含  
is 等于（比较对象）  
