import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as l,d as a,a as e,b as s,f as d}from"./app-LpUjRToi.js";const r={},t=e("h1",{id:"careers",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#careers","aria-hidden":"true"},"#"),s(" Careers")],-1),v=d(`<h2 id="_1-english" tabindex="-1"><a class="header-anchor" href="#_1-english" aria-hidden="true">#</a> 1. English</h2><p>What is your profession?</p><h3 id="_1-1-looking-for-work" tabindex="-1"><a class="header-anchor" href="#_1-1-looking-for-work" aria-hidden="true">#</a> 1.1. Looking for work</h3><ul><li>unemployed</li><li>between jobs (left one job and is looking for another)</li><li>recent graduage</li><li>career change</li><li>got laid off</li><li>quit</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I&#39;m between jobs right now.
I just got laid off.
I&#39;m in the middle of a career change.
I&#39;m a recent art graduate from NYU.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>work</li><li>job</li><li>role</li><li>position</li><li>industry</li><li>field</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I&#39;m looking for work.
I&#39;m looking for a role in marketing.
What industry are you in?
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>job description</li><li>CV / resume</li><li>full-time</li><li>part-time</li><li>internship</li></ul><p>Location</p><ul><li>Remote / Online / Virtual</li><li>In-person / In-office / In-location</li></ul><h3 id="_1-2-interview" tabindex="-1"><a class="header-anchor" href="#_1-2-interview" aria-hidden="true">#</a> 1.2. Interview</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Tell me a little about yourself.
Introduce yourself.
Tell me about yourself.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I am a software engineer with 5 years of experience.
I have been in marketing for 5 years as a director.
I just finished my translation degree at NYU.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I am a perfect fit because xxx.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-job-benefits" tabindex="-1"><a class="header-anchor" href="#_1-3-job-benefits" aria-hidden="true">#</a> 1.3. Job Benefits</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>What are the benefit like?
Her job has good benefits.
We have a competitive benefits package.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>insurance <ul><li>insurance</li><li>coverage</li><li>medical / health</li><li>dental</li><li>mental health</li></ul></li><li>living expenses <ul><li>stipend</li><li>living stipend</li><li>housing</li><li>housing stipend</li></ul></li><li>education <ul><li>paid training</li><li>continuing education stipend</li><li>student loan repayment</li></ul></li><li>retirement <ul><li>401k</li><li>IRA (individual retirement account)</li></ul></li><li>other <ul><li>stock</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>My insurance is through my job.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: What&#39;s your benefits package like?
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-promotions-raises" tabindex="-1"><a class="header-anchor" href="#_1-4-promotions-raises" aria-hidden="true">#</a> 1.4. Promotions &amp; Raises</h3><ul><li>Promotions <ul><li>get a promotion</li><li>promote || be promoted</li><li>promote ... to || be promoted to ...</li><li>... (is) up for promotion</li></ul></li><li>Raise <ul><li>a raise</li><li>get a raise</li><li>ask for a raise</li><li>salary negotiation</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I think I will get a promotion next year.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: I think I deserve a raise. 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-5-office-talk" tabindex="-1"><a class="header-anchor" href="#_1-5-office-talk" aria-hidden="true">#</a> 1.5. Office Talk</h3><ul><li>talk to <ul><li>talk to</li><li>touch base with sbd</li><li>loop sbd in</li></ul></li><li>align with sbd <ul><li>align with sbd</li><li>get on the same page with sbd</li></ul></li><li>come back to <ul><li>come back to</li><li>circle back</li><li>follow up on xxx later</li><li>table it</li><li>put a pin in it</li></ul></li><li>acronyms <ul><li>FYI (for your information)</li><li>ASAP (as soon as possible)</li><li>EOD (end of day)</li><li>ETA (estimated time of arrival)</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Have you toched base with Tom?
I&#39;ll loop Karen in.
...
What&#39;s your ETA?
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: Have you aligned with Lisa?
B: Not yet.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-6-business-trip" tabindex="-1"><a class="header-anchor" href="#_1-6-business-trip" aria-hidden="true">#</a> 1.6. Business Trip</h3><ul><li>(go on) a business trip (noun)</li><li>a business travel (noun)</li><li>travel for work (verb)</li><li>out of office</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I&#39;m going on a business trip tomorrow.
She&#39;s on a business travel this week.
I travel a lot for work.
I&#39;m out of office this week.
He&#39;s out of office until the 19th.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>expense (n. &amp; v.)</li><li>reimburse</li><li>per diem</li><li>company card || corporate card</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>My expenses are really high this month.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: I’m going on a business trip. 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-7-leave" tabindex="-1"><a class="header-anchor" href="#_1-7-leave" aria-hidden="true">#</a> 1.7. Leave</h3><ul><li><p>leave (uncountable)</p></li><li><p>time off</p></li><li><p>use / take</p></li><li><p>have / get</p></li><li><p>ask for</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I should use my leave.
I took some leave. || I took some time off.
I don&#39;t have any leave left.
I  will ask for time off.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>leave policy</li><li>paid leave || paid time off (PTO)</li><li>unpaid leave</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>What is your leave policy like?
I have 2 weeks of PTO.
My salary is low, but I get lots of PTO.
I asked for unpaid leave to visit home.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>medical leave</li><li>a sick day</li><li>parental leave (maternity, parenity)</li><li>bereavement leave</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>I took a sick day yesterday.
I&#39;m out of sick days.
We only get 12 weeks of maternity leave.
He is on bereavement leave.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: What’s your parental leave policy?
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-8-leaving-a-job" tabindex="-1"><a class="header-anchor" href="#_1-8-leaving-a-job" aria-hidden="true">#</a> 1.8. Leaving a Job</h3><ul><li>Geting Fired <ul><li>(be/get) fired || fired for cause</li><li>(be/get) terminated</li><li>(be/get) let go</li><li>(be/get) laid off</li><li>lose (a) job</li></ul></li><li>Quit <ul><li>quit</li><li>resign</li><li>submit (a) resignation</li><li>put in two-week &#39;s notice</li><li>(get/take) a new job</li><li>leave</li></ul></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>She was fired last week.
You&#39;re fired.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Conversations:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>A: Hey, where’s Susan? I haven’t seen her. 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-german" tabindex="-1"><a class="header-anchor" href="#_2-german" aria-hidden="true">#</a> 2. German</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>der Beruf, die Berufe – occupation
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,53);function u(o,c){return n(),l("div",null,[t,a(" more "),v])}const h=i(r,[["render",u],["__file","careers.html.vue"]]);export{h as default};
