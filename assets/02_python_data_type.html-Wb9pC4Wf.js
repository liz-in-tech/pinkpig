...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4-items" tabindex="-1"><a class="header-anchor" href="#_3-4-items" aria-hidden="true">#</a> 3.4. Items</h3><p>1、Unpack List Items</p><p>1）item1,item2,*rest = list</p><p>2）*list</p><p>2、Slice List Items</p><p>list[start：end：step]</p><p>start和end可以是正索引，也可以是负索引</p><p>左闭右开：[start，end）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>list1 = [1,2,3]
list2 = [4,5,6]
list2[:] = list1 # 将list2完全替换为list1
print(list2) # [1, 2, 3]
list2[2:] = list1 # 将list2的下标2及之后的元素用list1替换
print(list2) # [1, 2, 1, 2, 3]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># First Example
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,267);function c(u,m){return i(),s("div",null,[r,a(" more "),v])}const p=n(t,[["render",c],["__file","02_python_data_type.html.vue"]]);export{p as default};
