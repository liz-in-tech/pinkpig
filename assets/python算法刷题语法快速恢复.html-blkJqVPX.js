import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,e as d}from"./app-D6wNGShW.js";const a={},s=d(`<h1 id="python算法刷题语法快速恢复" tabindex="-1"><a class="header-anchor" href="#python算法刷题语法快速恢复" aria-hidden="true">#</a> Python算法刷题语法快速恢复</h1><h2 id="关键词" tabindex="-1"><a class="header-anchor" href="#关键词" aria-hidden="true">#</a> 关键词</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>and 与  
or  或  
not 非  
in  包含  
is 等于（比较对象）  
...
q[0] # 第一个元素
q[-1] # 最后一个元素
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="堆-优先队列" tabindex="-1"><a class="header-anchor" href="#堆-优先队列" aria-hidden="true">#</a> 堆/优先队列</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>q = [(-nums[i], i) for i in range(k)] # 默认是最小堆，通过取相反数来模拟最大堆
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="输入输出" tabindex="-1"><a class="header-anchor" href="#输入输出" aria-hidden="true">#</a> 输入输出</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import sys
...
递归，方法前要加self.  
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,62),l=[s];function r(t,v){return i(),n("div",null,l)}const m=e(a,[["render",r],["__file","python算法刷题语法快速恢复.html.vue"]]);export{m as default};
