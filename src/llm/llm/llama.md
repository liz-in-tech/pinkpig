...
## 2. 模型总体架构
![Llama模型总体架构](images/Llama_Overall_Architecture.png)

![源码对照模型架构](images/Llama_Source_Code_Architecture.png)

![Llama与Transformer的架构对比](images/llama_vs_transformer.png)

## 3. 超参数
![超参数](images/llama_hyperparameters.png)

## 4. 张量维度转换
![张量维度转换](images/llama_dim_trans.png)

![张量维度转换细节](images/LlamaForCausalLM.png)

## 5. 可训练参数量
![可训练参数量](images/llama_trainable_parameters.png)
...
```
### 6.2. GenerationMixin
![LlamaForCausalLM与GenerationMixin的继承关系](images/Inheritance.png)
```python
