...
- 句式：定语从句which+被动语态found
  - 定语从句修饰“animals”，关系代词“which”引导
- 时态：一般现在时
...
- 句式：时间状语从句when+同位语从句that+被动语态(spotted/taken)
  - 同位语从句引导词that指代reports
- 时态：主句一般过去时，从句过去完成时
...
- 句式：转折词however+时间状语从句as+原因状语从句for+定语从句who+非谓语动词given+被动语态given
  - 非谓语动词做后置定语（过去分词表被动）
- 时态：一般过去时
